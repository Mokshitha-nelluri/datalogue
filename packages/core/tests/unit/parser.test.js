...
import { parseAIResponse, downgradeConfidence, } from '../../src/prompt/parser.js';
...
LIMIT 10`;
        ...
        expect(result.summary).toBe('Returns the top 10 customers by total spend.');
...
SELECT id FROM orders LIMIT 10`;
    ...
    it('throws DatalogueError on CANNOT_ANSWER', () => {
        ...
        try {
            ...
            expect(err.message).toContain('No revenue column');
        }
    });
