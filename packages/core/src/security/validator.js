 ...
 */
function extractTablesFromTableList(tableList) {
    const tables = [];
 ...
 */
function fallbackValidation(sql, opts) {
...
export function validateSQL(sql, opts) {
    ...
    const referencedTables = extractTablesFromTableList(parseResult.tableList ?? []);
